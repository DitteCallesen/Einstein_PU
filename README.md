...
This application uses a MySQL database, the php files can be found here: https://github.com/DitteCallesen/phpfiles.Einstein

This project is made by Group 8: Truong, Simon, Maria, and Ditte
